...
const COMMANDS = ["help", "about", "projects", "whoami", "repo", "banner", "clear", "blog"]
...
function commandHandler(input: string) {
        ...
        switch (input) {
                ...
                case "repo":
                        ...
                        break
                case "home":
                        writeLines(["Redirecting to alexlevy0.com...", "<br>"])
                        setTimeout(() => {
...
const initEventListeners = () => {
        ...
        console.log("%cPassword: admin", "color: red; font-size: 20px;")
}
